...
export default function VariablesExplain() {
  return (
    <div className="section">
      ...
      <p className="test" style={{ color: "var(--muted)" }}>
        We need a small set of blood test values to run the fuzzy predictor. Each is briefly explained below.
      </p>
      ...
      <div style={{ marginTop: 20, textAlign: "center" }}>
        <Link to="/checklist">
          <button className="btn primary-btn">I have all test results — Proceed</button>
        </Link>
      </div>
    </div>
  );
